    ...
    <layout class-name="IndexRouter">
        <view class="flex flex-row justify-between items-center px-[34px]">
            ...
            <view class="flex items-center">
                ...
                <image class="ml-[25px] border-full w-[92px] h-[92px]" src="/static/images/no-login.png"></image>
            </view>
        </view>
        <view class="mt-[18px]">
                        ...
                        <view class="news mr-[56px]">
                            <view class="teletext flex justify-between">
                                ...
                                <image
                                    ...
                                    src="https://ml.globenewswire.com/Resource/Download/05408ba1-26b1-4fdd-8f48-1af4df373348"
                                ></image>
                            </view>
