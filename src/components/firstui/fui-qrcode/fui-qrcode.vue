<template>
    <!-- #ifdef APP-NVUE -->
    <gcanvas :ref='canvasId' :style="{ width: w + 'px', height:h + 'px'  }" @longpress='longtap' @touchend='touchend'
             @touchstart='touchstart'>
    </gcanvas>
    <!-- #endif -->

    <!-- #ifndef APP-NVUE || MP-QQ -->
    <canvas v-if='canvasId' :id='canvasId' :canvas-id='canvasId' :style="{width:w+'px',height:h+'px'}"
            @longtap='longtap' @touchend='touchend' @touchstart='touchstart'></canvas>
    <!-- #endif -->

    <!-- #ifdef MP-QQ -->
    <canvas :style="{width:w+'px',height:h+'px'}" canvas-id='canvas_qrcode' @longtap='longtap' @touchend='touchend'
